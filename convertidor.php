    ...
    <script>
        ...
        function cargarMammoth() {
            if (!mammothLoaded) {
                ...
                script.src = 'https://cdn.jsdelivr.net/npm/mammoth@1.4.0/mammoth.browser.min.js';
        ...
        async function convertirWordAPDF() {

            cargarMammoth();

            var inputFile = document.getElementById('archivo').files[0];
            ...
            reader.onload = async function (event) {
                ...
                try {
                    ...
                    // Extraer el contenido del arrayBuffer usando Mammoth
                    var content = await mammoth.extractRawText({ arrayBuffer: arrayBuffer });
                    ...
                    // Generar el PDF directamente desde el contenido
                    var pdfBlob = await html2pdf(contentDiv, pdfOptions).output();
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    <h3 class="font-weight-bold">Convertidor a PDF</h3>
                                    <h6 class="font-weight-normal mb-0">En este apartado podras convertir tus archivos
                                        WORD
                                        a PDF</h6>
                                </div>
                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-text">Ingresa el archivo word a convertir</h4>
                                <div class="form-group">
                                    <input type="file" id="archivo" accept=".docx" class="form-control">
                                    <label class="input-group-text" for="archivo"><i class="fas fa-file"></i></label>
                                    <button onclick="convertirWordAPDF()" class="btn btn-danger mr-2">Convertir y
                                        Descargar
                                        PDF
                                    </button>
                                </div>
