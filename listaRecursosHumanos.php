                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-description">
                                        Todos los archivos de la categoría Recursos Humanos.
                                    </p>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                if (!$conexion->connect_error) {
                                                    // Consulta SQL para obtener los archivos de la categoría Recursos Humanos
                                                    $sql = "SELECT id, nombre, tipo FROM archivos WHERE categoria = 'recursos humanos' AND eliminado = 0"; // Agregamos la condición para filtrar por categoría y no mostrar archivos eliminados
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        while ($fila = $result->fetch_assoc()) {
                                                            ...
                                                            echo "<td>
                                                                ...
                                                                <a href='delete_recursos_humano.php?id={$fila['id']}' class='btn btn-danger btn-sm'>
