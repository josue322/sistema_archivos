...
<head>
    ...
    <title>GERENCIA DE DESARROLLO SOCIAL Y HUMANO</title>
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">GERENCIA DE DESARROLLO SOCIAL Y HUMANO
                                    </h4>
                                    <p class="card-description">
                                        Todos los archivos de la categoría Gerencia de Desarrollo Social y Humano.
                                    </p>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                if (!$conexion->connect_error) {
                                                    // Consulta SQL para obtener los archivos de la categoría Gerencia de Desarrollo Social y Humano
                                                    $sql = "SELECT id, nombre, tipo FROM archivos WHERE categoria = 'gerencia de desarrollo social y humano' AND eliminado = 0";
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        while ($fila = $result->fetch_assoc()) {
                                                            ...
                                                            echo "<td>
                                                                    ...
                                                                    <a href='delete_desarrollo_social.php?id={$fila['id']}' class='btn btn-danger btn-md'>
