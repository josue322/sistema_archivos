                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-description">
                                        Todos los archivos de la categoría Tesorería.
                                    </p>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                if (!$conexion->connect_error) {
                                                    // Consulta SQL para obtener los archivos de la categoría Tesorería
                                                    $sql = "SELECT id, nombre, tipo FROM archivos WHERE categoria = 'tesoreria' AND eliminado = 0";
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        while ($fila = $result->fetch_assoc()) {
                                                            ...
                                                            echo "<td>
                                                                    ...
                                                                    <a href='delete_tesoreria.php?id={$fila['id']}' class='btn btn-danger btn-md'>
