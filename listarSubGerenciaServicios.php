...
<head>
    ...
    <title>SUB GERENCIA DE SERVICIOS MUNICIPALES</title>
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">SUB GERENCIA DE SERVICIOS MUNICIPALES
                                    </h4>
                                    <p class="card-description">
                                        Todos los archivos de la categoría Sub Gerencia de Servicios Municipales.
                                    </p>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                if (!$conexion->connect_error) {
                                                    // Consulta SQL para obtener los archivos de la categoría Sub Gerencia de Servicios Municipales
                                                    $sql = "SELECT id, nombre, tipo FROM archivos WHERE categoria = 'sub gerencia de servicios municipales' AND eliminado = 0";
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        while ($fila = $result->fetch_assoc()) {
                                                            ...
                                                            echo "<td>
                                                                    ...
                                                                    <a href='delete_sub_gerencia_servicios.php?id={$fila['id']}' class='btn btn-danger btn-md'>
