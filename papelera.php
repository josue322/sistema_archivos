...
<head>
    ...
    <title>🗑️Papelera de Reciclaje</title>
...
<body>
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel col-lg-10 col-md-10">
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">🗑️PAPELERA DE RECICLAJE</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                if (!$conexion->connect_error) {
                                                    // Consultar la base de datos para obtener la lista de archivos eliminados
                                                    $sql = "SELECT id, nombre, tipo, categoria FROM archivos WHERE eliminado = 1"; // Mostrar solo archivos eliminados
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        while ($fila = $result->fetch_assoc()) {
                                                            ...
                                                            echo '<td>';
                                                            echo '<a href="restore.php?id=' . $fila['id'] . '" class="btn btn-success btn-sm">';
                                                            echo '<i class="fas fa-undo"></i>';
                                                            echo '</a>  ';
                                                            echo '<a href="delete_permanent.php?id=' . $fila['id'] . '" class="btn btn-danger btn-sm">';
                                                        ...
                                                        echo '<tr><td colspan="5">La papelera de reciclaje está vacía.</td></tr>';
                                                    }
                                                    $conexion->close();
                                                } else {
